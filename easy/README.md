...
```python
from core.backtest.easy import 백테스트, 골든크로스
...
```python
from core.backtest.easy import 백테스트, 전략, sma, crossover
...
```python
from core.backtest import BacktestEngine, Strategy
# ... 기존 클래스 상속 방식
```
...
```python
from core.backtest.easy import sma, ema, rsi, macd, price, crossover, crossunder
...
```python
from core.backtest.easy import 백테스트, 최적화, 전략, 골든크로스
...
```python
from core.backtest.easy import optimize, goldenCross
...
```python
from core.backtest.easy import quickTest
